...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* ---------- how it works ---------- */
  .about { display: grid; gap: 20px; grid-template-columns: 1fr 1fr; padding: 30px 0 8px; }
  .about p { margin: 0; color: var(--ink-2); max-width: 62ch; }
  .about h3 {
  ...
  .row {
    display: grid; grid-template-columns: 124px 1.25fr 1.6fr 0.95fr;
  ...
  .detail { color: var(--muted); font-size: 14.5px; margin-top: 3px; max-width: 52ch; }
  ...
  .prep, .due { font-size: 14.5px; line-height: 1.42; }
